...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="/pro" class="btn btn-warning">Ir Producto</a></li>
    </ol>
  </section>
    ...
    <br/>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-info" href="${pageContext.request.contextPath}/formProducto">Nuevo</a>  
                </div>
            </div>
              </form>
          </div>
          ...
          <tbody>
                <c:forEach items="${ListaProducto}" var="dato">
                      <tr>
                        ...
                        <td>${dato.precio}</td>
                        <td><a href="${pageContext.request.contextPath}/elim?id=${dato.idProducto}">E</a></td>
                      </tr>
              </c:forEach> 
            </tbody>           
          </table>  
